...
include "connect.php";
				...
				if(isset($_POST['submit-add-admin-account'])){
					$usernameadmin = $_SESSION['adminusernamefind'];
					$passwordadmin = $_POST['input-admin-account-password-add'];
					$nameadmin = ucwords($_POST['input-admin-account-name-add']);
